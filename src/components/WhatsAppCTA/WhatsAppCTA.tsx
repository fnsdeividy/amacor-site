...
const variantStyles: Record<NonNullable<WhatsAppCTAProps['variant']>, string> = {
  primary:
    'w-full bg-whatsapp text-white hover:bg-whatsapp-dark px-6 py-4 text-body-lg',
  secondary:
    'bg-confirmation-light text-whatsapp-dark border border-whatsapp hover:bg-green-100 px-6 py-3',
  compact:
    'bg-whatsapp text-white hover:bg-whatsapp-dark px-4 py-2 text-sm',
};
