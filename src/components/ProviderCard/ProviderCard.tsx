...
export function ProviderCard({
  ...
  return (
    <Link to={`/rede-credenciada/${provider.id}`} className="block">
      <article className={`group rounded-2xl bg-white border overflow-hidden shadow-card hover:shadow-card-hover hover:-translate-y-0.5 transition-all duration-300 cursor-pointer ${provider.redePropria ? 'border-primary-400 ring-2 ring-primary-200/60 shadow-elevated' : 'border-warm-200'}`}>
