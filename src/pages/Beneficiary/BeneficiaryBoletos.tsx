...
import { getBoletos } from '../../services/api';
...
export default function BeneficiaryBoletos() {
  ...
  /**
   * Inicia download do PDF do boleto
   */
  function handleDownload(boleto: Boleto) {
    if (boleto.pdfUrl) {
    ...
    return (
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold text-primary-green mb-8">Segunda Via de Boletos</h1>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button
                    ...
                    disabled={!boleto.pdfUrl}
                    aria-label={`Download boleto vencimento ${boleto.vencimento}`}
                    title="Download PDF"
                    className="flex items-center justify-center min-w-[48px] min-h-[48px] w-12 h-12 bg-primary-green text-white rounded-lg hover:bg-green-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
